...
<!-- BEGIN: main -->
<link rel="stylesheet" href="{NV_BASE_SITEURL}themes/{TEMPLATE}/tms/css/spotlight.css">
<script src="{NV_BASE_SITEURL}themes/{TEMPLATE}/tms/js/spotlight.bundle.js"></script>
