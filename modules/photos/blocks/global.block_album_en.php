...
if( !nv_function_exists( 'nv_block_album' ) )
{
	...
	function nv_block_album( $block_config )
	{
		...
		if( !empty( $list ) )
		{
			...
			if( file_exists( NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/' . $mod_file . '/block_album_en.tpl' ) )
			{
			...
			$xtpl = new XTemplate( 'block_album_en.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/' . $mod_file );
